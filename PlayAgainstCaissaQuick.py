...
class Main:
    ...
    def __init__(self):
        ...
        self.game = Game()
        # If we don't do this, we crash because we initalize tracking dict there
    ...
    def play_game(self):
        ...
        if (self.player_color == "white" and self.game.board.state.whose_move == WHITE) or \
            ...
            caissa_move = Caissa.makeMove(self.game.board.state, "hi", CAISSA_TIME_LIMIT)
            # form of ((6, 0), (2, 0))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if board.state.board[clicked_row][clicked_col] != 0:
                    ...
                    # we could fix this to be one if statement, we could also not care
